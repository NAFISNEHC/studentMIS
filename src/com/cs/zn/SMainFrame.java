...
public class SMainFrame {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(SMainFrame.class, "/image/10.png"));
		...
		Lcomposite.setBackgroundImage(SWTResourceManager.getImage("./src/image/11.jpg"));
		...
		TreeItem ti_search_2 = new TreeItem(ti_search, SWT.NONE);
		ti_search_2.setText("个人信息");
		...
		tree.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (selStr.equalsIgnoreCase("修改")) {
					new UpMyComposite(Rcomposite1, SWT.NONE, shell, sid);
				} else if (selStr.equalsIgnoreCase("查看全部")) {
					new SeaAllComposite(Rcomposite1, SWT.NONE, shell, false);
				} else if (selStr.equalsIgnoreCase("个人信息")) {
					new SeaMyComposite(Rcomposite1, SWT.NONE, shell, sid);
				} else {
					// 最初界面图片
					Composite composite_1 = new Composite(Rcomposite1, SWT.NONE);
					composite_1.setBackgroundImage(SWTResourceManager.getImage("./src/image/12.jpg"));
